...
<html>
<head>
	<title>Staff Update Vehicle </title>
      ...
      <form method="POST">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <table style="margin-left: 600px;margin-right: auto;width: 800px;margin-top: 40px;">
              <tr>
                <td style="text-align: center;padding-right: 20px;" colspan="2"><h3>UPDATE VEHICLE</h3></td>
              </tr>
              <tr>
                <td style="text-align: right;padding-right: 20px;">Vehicle Brand :</td>
                <td><input style="width: 400px;" type="text" id="vehicleName" name="vehicleName" maxlength="50" required /></td>
              </tr>
              <tr>
                <td style="text-align: right;padding-right: 20px;">Vehicle Model :</td>
                <td><input style="width: 400px;margin-top: 5px;" type="text" id="vehicleModel" name="vehicleModel" maxlength="50" required /></td>
              </tr>
              <tr>
                <td style="text-align: right;padding-right: 20px;">Plate Number :</td>
                <td><input style="width: 400px;margin-top: 5px;" type="text" id="vehiclePlate" name="vehiclePlate" maxlength="50" required /></td>
              </tr>
              <tr>
                <td style="text-align: right;padding-right: 20px;">Vehicle Color :</td>
                <td><input style="width: 400px;margin-top: 5px;" type="text" id="vehicleColor" name="vehicleColor" maxlength="50" required /></td>
              </tr>
              <tr>
                <td></td>
                <input type="hidden" name="userID" value="<?php echo $data['userID']?>" />
                <td style="text-align: right;margin-top: 20px;"><button type="submit" name="updateButton" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Update</button></td>
              </tr>
            </table>
          </div>
        </form>
