        ...
        <form method="POST">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <table style="margin-left: 600px;margin-right: auto;width: 800px;margin-top: 40px;">
              <tr>
                <td style="text-align: center;padding-right: 20px;" colspan="2"><h3>ADD VEHICLE</h3></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="text-align: right;margin-top: 20px;"><button type="submit" name="registerVehicle" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Register</button></td>
              </tr>
            </table>
          </div>
        </form>
